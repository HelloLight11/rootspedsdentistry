    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-[#7cb342]">
          ...
          {benefits.map((benefit, index) => (
            <AnimatedSection key={index} delay={index * 0.1}>
              <div className="relative flex flex-col items-center">
                ...
                <div
                  className="relative w-full border-2 border-[#7cb342] rounded-t-full pt-20 pb-10 px-6 text-center"
                  style={{
                ...
                >
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-bold text-[#3d2f24] mb-4 mt-4">
                    {benefit.title}
                  </h3>
