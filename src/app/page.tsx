...
export default function Home() {
  return (
    <>
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            Where Little Smiles
            <br />
            <span className="text-[#a8e6cf]">Take Root</span>
          </motion.h1>
          ...
          >
            Dr. Joey Pedram and our team create positive dental experiences
          ...
          >
            ...
            <span className="text-white/70">from 100+ Google Reviews</span>
          </motion.div>
      ...
      {/* Why Choose Us */}
      <section className="py-20 bg-gradient-to-b from-[#f8f9fc] to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1e293b] mb-4">
            ...
            {[
              ...
              <AnimatedSection key={feature.title} delay={index * 0.1}>
                <div className="text-center group">
                  <div className="w-16 h-16 bg-[#2d5a27] rounded-2xl flex items-center justify-center mx-auto mb-4 text-white group-hover:scale-110 transition-transform duration-300">
                    {feature.icon}
                  </div>
            ...
            <AnimatedSection direction="right" delay={0.2}>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                {['USC School of Dentistry', 'Tufts Pediatric Residency', '15+ Years Experience'].map((item) => (
                  <span key={item} className="inline-flex items-center gap-2 bg-[#f8f9fc] px-4 py-2 rounded-full text-sm text-[#334155]">
      ...
      {/* Services */}
      <section className="py-20 bg-gradient-to-b from-[#f8f9fc] to-[#f1f5f9]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1e293b] mb-4">
              Our Services
            ...
            {services.map((service, index) => (
              <AnimatedSection key={service.title} delay={index * 0.08}>
                <Link href={service.href} className="block h-full group">
                  <div className="bg-white p-6 rounded-2xl h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 hover:border-[#2d5a27]/20">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-lg text-[#4b5563]">
              See why parents trust us with their children&apos;s smiles.
            </p>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <AnimatedSection key={testimonial.name} delay={index * 0.15}>
                <div className="bg-[#f8f9fc] p-6 rounded-2xl h-full">
                  ...
                  <p className="text-sm text-[#4b5563]">{testimonial.name}</p>
                </div>
              </AnimatedSection>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <AnimatedSection>
              <div className="bg-white rounded-2xl p-8 h-full">
                <h3 className="text-xl font-bold text-[#1e293b] mb-4">Insurance & Payment</h3>
                <p className="text-[#4b5563] mb-4">
                  We accept most PPO plans and offer flexible payment options.
                </p>
                <ul className="space-y-2">
                  {['Most PPO plans accepted', 'Flexible payment plans', 'HSA/FSA eligible'].map((item) => (
            ...
            <AnimatedSection delay={0.1}>
              <div className="bg-white rounded-2xl p-8 h-full">
                <h3 className="text-xl font-bold text-[#1e293b] mb-4">Office Hours</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between text-[#4b5563]">
                    <span>Monday - Thursday</span>
                    <span className="font-medium text-[#1e293b]">9:00 AM - 5:00 PM</span>
                  </div>
                  <div className="flex justify-between text-[#4b5563]">
                    <span>Friday - Saturday</span>
                    <span className="font-medium text-[#1e293b]">9:00 AM - 2:00 PM</span>
                  </div>
                  <div className="flex justify-between text-[#4b5563]">
                    <span>Sunday</span>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <p className="text-sm text-[#4b5563]">
                    <span className="text-[#2d5a27] font-medium">West Los Angeles</span> &bull; Easy parking available
                  </p>
                </div>
              </div>
            </AnimatedSection>
      ...
      <section className="py-20 bg-[#2d5a27]">
        <AnimatedSection className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-white text-[#2d5a27] px-8 py-4 rounded-full font-semibold text-lg hover:bg-[#a8e6cf] transition-all duration-300 hover:shadow-xl"
            >
              Book Appointment
            </Link>
            <a
