      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#2d5a27]/80 via-[#2d5a27]/70 to-[#2d5a27]/80" />
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <motion.span
            ...
            className="inline-block bg-[#b8f5a6] text-[#2d5a27] px-5 py-2 rounded-full text-sm font-semibold mb-6"
          >
          ...
          >
            Where Little <span className="text-[#b8f5a6]">Smiles</span> Take Root
          </motion.h1>
          ...
          >
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 bg-[#b8f5a6] text-[#2d5a27] px-8 py-4 rounded-full font-semibold text-lg hover:bg-white transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
              Book Appointment
