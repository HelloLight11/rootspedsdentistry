                  ...
                  <div className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-[#2d5a27] hover:shadow-xl transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] h-full">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#2d5a27] to-[#478449] rounded-full flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                      >
                        <path d="M12 2C8.5 2 6 4.5 6 7.5c0 1.5.5 2.8 1.3 3.8-.3.8-.5 1.7-.6 2.7L6 22h4l.5-5h3l.5 5h4l-.7-8c-.1-1-.3-1.9-.6-2.7.8-1 1.3-2.3 1.3-3.8C18 4.5 15.5 2 12 2zm0 2c2.5 0 4 1.8 4 3.5 0 1-.4 2-1 2.7-.4.4-.6 1-.5 1.6.1.6.2 1.2.3 1.7l.4 4.5h-1.4L13.5 15h-3l-.3 3h-1.4l.4-4.5c.1-.5.2-1.1.3-1.7.1-.6-.1-1.2-.5-1.6-.6-.7-1-1.7-1-2.7C8 5.8 9.5 4 12 4z" />
                      </svg>
                    </div>
