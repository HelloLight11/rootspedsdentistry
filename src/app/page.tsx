    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(to bottom, rgba(45, 90, 39, 0.7), rgba(45, 90, 39, 0.8)), url("https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=2074")',
          }}
        />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection delay={0.2}>
            <p className="text-lg text-[#595351] leading-relaxed max-w-3xl mx-auto text-center">
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(to bottom, rgba(45, 90, 39, 0.85), rgba(45, 90, 39, 0.9)), url("https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=2070")',
        }}
      >
