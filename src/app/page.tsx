                  ...
                  <div className="bg-white p-8 rounded-2xl border border-gray-100 hover:border-[#2d5a27] hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#2d5a27] to-[#478449] rounded-full flex items-center justify-center mb-6">
                      <svg
                        ...
                        viewBox="0 0 32 32"
                      >
                        <path d="M16 2c-3.3 0-6.3 1.3-8.5 3.5S4 10.7 4 14c0 2.5.8 4.8 2.1 6.7.5.7.9 1.5 1.1 2.3l1.8 7.5c.2.9 1 1.5 1.9 1.5h2.2c.8 0 1.5-.5 1.8-1.2l1.1-2.8 1.1 2.8c.3.7 1 1.2 1.8 1.2h2.2c.9 0 1.7-.6 1.9-1.5l1.8-7.5c.2-.8.6-1.6 1.1-2.3 1.3-1.9 2.1-4.2 2.1-6.7 0-3.3-1.3-6.3-3.5-8.5S19.3 2 16 2z" />
                      </svg>
                    </div>
